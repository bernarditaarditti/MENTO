...
export default function FamilyLevel2PlayPage() {
  ...
  // Opción correcta: "Pasar tiempo en casa jugando juegos de mesa" (índice 0) o "Aprovechar para cocinar juntos una comida especial" (índice 1)
  // Opciones incorrectas: "Todo arruinado, el día ya no sirve." (índice 2)
  ...
  const handleSubmit = () => {
    ...
    if (correctAnswers.includes(selectedOption)) {
      ...
      localStorage.setItem("family_level_2_completed", "true")
    }
  }
