...
export default function FamilyLevel1PlayPage() {
  ...
  // Opción correcta: 4 (índice 3) - "Está enojado porque quiere más conexión conmigo"
  ...
  const handleSubmit = () => {
    ...
    if (correctAnswers.includes(selectedOption)) {
      ...
      // Marcar el nivel 1 como completado en localStorage
      localStorage.setItem("family_level_1_completed", "true")
    }
  }
  ...
  const options = [
    ...
    "Está enojado porque quiere más conexión conmigo"
  ]
