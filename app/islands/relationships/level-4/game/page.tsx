        ...
        >
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2" style={{ zIndex: 10, top: "-32px" }}>
            <div className="relative">
              {/* Gray star above - centered, touching the circle */}
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                ...
                >
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="#9CA3AF" strokeWidth="1.5" strokeLinejoin="round" />
                </svg>
              </div>
              {/* Level circle */}
              <div
                className="w-14 h-14 rounded-full flex items-center justify-center text-white font-bold text-lg"
                style={{ backgroundColor: "#FEBAB2", fontFamily: "var(--font-poppins)" }}
              >
                4
              </div>
            </div>
          ...
          <div className="flex flex-col gap-2 mt-6" style={{ color: "#FF8FA3", fontFamily: "var(--font-poppins)" }}>
            ...
            <div className="text-center">
              ...
              <p
                className="font-bold"
                style={{ fontSize: "17px", lineHeight: "1.4", marginTop: "12px", color: "#F36E86" }}
              >
                Discusión de pareja
              </p>
            </div>
