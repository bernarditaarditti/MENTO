...
export default function WorkIslandPage() {
  ...
  const getInitialCompletedLevels = (): Set<number> => {
    ...
    if (localStorage.getItem("work_level_1_completed") === "true") completed.add(1)
    if (localStorage.getItem("work_level_2_completed") === "true") completed.add(2)
    if (localStorage.getItem("work_level_3_completed") === "true") completed.add(3)
    if (localStorage.getItem("work_level_4_completed") === "true") completed.add(4)
