...
export default function WorkLevel5PlayPage() {
  ...
  // Opciones correctas: "Quizás esta no era la beca adecuada, podés aplicar a otra con más chances." (índice 1), "Una negativa no define tu valor; este feedback puede ayudarte a mejorar para la próxima." (índice 3)
  // Opciones incorrectas: "Sí, es injusto, quizás no vale la pena seguir intentando." (índice 0), "Tranquilo, olvidate del tema y no pienses más." (índice 2), "Bueno, si no te eligieron, por algo será." (índice 4), "Yo en tu lugar estaría igual, debe ser una señal de que no es lo tuyo." (índice 5)
  const correctAnswers = [1, 3]
  const incorrectAnswers = [0, 2, 4, 5]
  ...
  const options = [
    ...
    "Una negativa no define tu valor; este feedback puede ayudarte a mejorar para la próxima.",
    "Bueno, si no te eligieron, por algo será.",
    "Yo en tu lugar estaría igual, debe ser una señal de que no es lo tuyo."
  ]
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
        ...
        >
          <div className="flex flex-col gap-3" style={{ color: "#F36E86", fontFamily: "var(--font-poppins)" }}>
            <p className="font-medium text-center" style={{ fontSize: "15px" }}>
              Un colega no fue elegido para una beca y dice:
            </p>
            <p className="font-medium text-center" style={{ fontSize: "15px" }}>
              "Nunca voy a progresar, no sirvo para esto."
            </p>
          </div>
        </div>
      ...
      {hoveredOption !== null && evaluated && !showSuccessPopup && (
