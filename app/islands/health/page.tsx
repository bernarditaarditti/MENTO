...
export default function HealthIslandPage() {
  ...
  const getInitialCompletedLevels = (): Set<number> => {
    ...
    if (localStorage.getItem("health_level_1_completed") === "true") completed.add(1)
    if (localStorage.getItem("health_level_2_completed") === "true") completed.add(2)
    if (localStorage.getItem("health_level_3_completed") === "true") completed.add(3)
    if (localStorage.getItem("health_level_4_completed") === "true") completed.add(4)
  ...
  // Verificar el progreso de los niveles
  useEffect(() => {
    ...
    if (level4Completed === "true") {
      // Si el nivel 4 está completado, el nivel actual es 5
      setCurrentLevel(5)
    } else if (level3Completed === "true") {
      // Si el nivel 3 está completado, el nivel actual es 4
      setCurrentLevel(4)
    } else if (level2Completed === "true") {
      // Si el nivel 2 está completado, el nivel actual es 3
      setCurrentLevel(3)
    } else if (level1Completed === "true") {
      // Si solo el nivel 1 está completado, el nivel actual es 2
      setCurrentLevel(2)
    }
  }, [])
  ...
  const getLevelColor = (level: number) => {
    // Si el nivel es <= nivel actual, usa el color verde #00B46F
    // Si es mayor, usa el color verde claro #8CDDBE
